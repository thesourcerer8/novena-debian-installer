...
sudo apt-get install u-boot-tools lvm2 cryptsetup kosagi-repo initramfs-tools build-essential u-boot-novena exfat-utils irqbalance-imx linux-image-novena linux-firmware-image-novena linux-headers-novena
